...
foreign lib {
	...
	@(link_name="SDL_AddHintCallback") add_hint_callback_c  							:: proc(name: ^u8, callback: Hint_Callback, userdata: rawptr)  																														 ---;
	...
	@(link_name="SDL_AudioInit") audio_init_c 									:: proc(driver_name: ^u8) -> i32																																					 ---;
	...
	@(link_name="SDL_CreateCursor") create_cursor_c 								:: proc(data: ^u8, mask: ^u8, w, h: i32, hot_x, hot_y: i32) -> ^Cursor																												 ---;
	...
	@(link_name="SDL_DelHintCallback") del_hint_callback_c 							:: proc(name: ^u8, callback: Hint_Callback, userdata: rawptr)																														 ---;
	...
	@(link_name="SDL_GL_ExtensionSupported") gl_extension_supported_c 						:: proc(extension: ^u8) -> Bool																																						 ---;
	...
	@(link_name="SDL_GL_GetProcAddress") gl_get_proc_address_c 							:: proc(name: ^u8) -> rawptr																																						 ---;
	@(link_name="SDL_GL_GetSwapInterval") gl_get_swap_interval 							:: proc() -> i32																																									 ---;
	@(link_name="SDL_GL_LoadLibrary") gl_load_library_c 								:: proc(path: ^u8) -> i32																																							 ---;
	...
	@(link_name="SDL_GameControllerAddMapping") game_controller_add_mapping_c 					:: proc(mapping_string: ^u8) -> i32																																					 ---;
	...
	@(link_name="SDL_GameControllerGetAxisFromString") game_controller_get_axis_from_string_c 			:: proc(pch_string: ^u8) -> ^u8																																						 ---;
	...
	@(link_name="SDL_GameControllerGetButtonFromString") game_controller_get_button_from_string_c 		:: proc(pch_string: ^u8) -> Game_Controller_Button																																	 ---;
	@(link_name="SDL_GameControllerGetJoystick") game_controller_get_joystick 					:: proc(game_controller: ^Game_Controller) -> ^Joystick																																 ---;
	@(link_name="SDL_GameControllerGetStringForAxis") game_controller_get_string_for_axis_c 			:: proc(axis: Game_Controller_Axis) -> ^u8																																			 ---;
	@(link_name="SDL_GameControllerGetStringForButton") game_controller_get_string_for_button_c 		:: proc(button: Game_Controller_Button) -> ^u8																																		 ---;
	@(link_name="SDL_GameControllerMapping") game_controller_mapping_c 						:: proc(game_controller: ^Game_Controller) -> ^u8																																	 ---;
	@(link_name="SDL_GameControllerMappingForGUID") game_controller_mapping_for_guid_c 				:: proc(guid: Joystick_Guid) -> ^u8																																					 ---;
	@(link_name="SDL_GameControllerName") game_controller_name_c 							:: proc(game_controller: ^Game_Controller) -> ^u8																																	 ---;
	@(link_name="SDL_GameControllerNameForIndex") game_controller_name_for_index_c 				:: proc(joystick_index: i32) -> ^u8																																					 ---;
	...
	@(link_name="SDL_GetAudioDeviceName") get_audio_device_name_c 						:: proc(index: i32, iscapture: i32) -> ^u8																																			 ---;
	@(link_name="SDL_GetAudioDeviceStatus") get_audio_device_status 						:: proc(dev: Audio_Device_Id) -> Audio_Status																																			 ---;
	@(link_name="SDL_GetAudioDriver") get_audio_driver_c 								:: proc(index: i32) -> ^u8																																							 ---;
	@(link_name="SDL_GetAudioStatus") get_audio_status 								:: proc() -> Audio_Status																																							 ---;
	@(link_name="SDL_GetBasePath") get_base_path_c 								:: proc() -> ^u8																																									 ---;
	...
	@(link_name="SDL_GetClipboardText") get_clipboard_text_c 							:: proc() -> ^u8																																									 ---;
	...
	@(link_name="SDL_GetCurrentAudioDriver") get_current_audio_driver_c 						:: proc() -> ^u8																																									 ---;
	@(link_name="SDL_GetCurrentDisplayMode") get_current_display_mode 						:: proc(display_index: i32, mode: ^Display_Mode) -> i32																																 ---;
	@(link_name="SDL_GetCurrentVideoDriver") get_current_video_driver_c 						:: proc() -> ^u8																																									 ---;
	...
	@(link_name="SDL_GetDisplayName") get_display_name_c 								:: proc(display_index: i32) -> ^u8																																					 ---;
	@(link_name="SDL_GetDisplayUsableBounds") get_display_usable_bounds 						:: proc(display_index: i32, rect: ^Rect) -> i32																																		 ---;
	@(link_name="SDL_GetError") get_error_c 									:: proc() -> ^u8																																									 ---;
	...
	@(link_name="SDL_GetHint") get_hint_c 										:: proc(name: ^u8) -> ^u8																																							 ---;
	@(link_name="SDL_GetHintBoolean") get_hint_boolean 								:: proc(name: ^u8, default_value: Bool) -> Bool																																		 ---;
	@(link_name="SDL_GetKeyFromName") get_key_from_name_c 							:: proc(name: ^u8) -> Keycode																																						 ---;
	@(link_name="SDL_GetKeyFromScancode") get_key_from_scancode 							:: proc(scancode: Scancode) -> Keycode																																				 ---;
	@(link_name="SDL_GetKeyName") get_key_name_c 									:: proc(key: Keycode) -> ^u8																																						 ---;
	...
	@(link_name="SDL_GetPixelFormatName") get_pixel_format_name_c 						:: proc(format: u32) -> ^u8																																							 ---;
	@(link_name="SDL_GetPlatform") get_platform_c 									:: proc() -> ^u8																																									 ---;
	@(link_name="SDL_GetPowerInfo") get_power_info 									:: proc(secs, pct: ^i32) -> Power_State																																				 ---;
	@(link_name="SDL_GetPrefPath") get_pref_path_c 								:: proc(org, app: ^u8) -> ^u8																																						 ---;
	...
	@(link_name="SDL_GetRevision") get_revision_c 									:: proc() -> ^u8																																									 ---;
	...
	@(link_name="SDL_GetScancodeFromName") get_scancode_from_name_c 						:: proc(name: ^u8) -> Scancode																																						 ---;
	@(link_name="SDL_GetScancodeName") get_scancode_name_c 							:: proc(scancode: Scancode) -> ^u8																																					 ---;
	...
	@(link_name="SDL_GetThreadName") get_thread_name_c 								:: proc(thread: ^Thread) -> ^u8																																						 ---;
	...
	@(link_name="SDL_GetVideoDriver") get_video_driver_c 								:: proc(index: i32) -> ^u8																																							 ---;
	...
	@(link_name="SDL_GetWindowData") get_window_data_c 								:: proc(window: ^Window, name: ^u8) -> rawptr																																		 ---;
	...
	@(link_name="SDL_GetWindowTitle") get_window_title_c 								:: proc(window: ^Window) -> ^u8																																						 ---;
	...
	@(link_name="SDL_HapticName") haptic_name_c 									:: proc(device_index: i32) -> ^u8																																					 ---;
	...
	@(link_name="SDL_JoystickGetGUIDFromString") joystick_get_guid_from_string_c 				:: proc(pch_guid: ^u8) -> Joystick_Guid																																				 ---;
	...
	@(link_name="SDL_JoystickName") joystick_name_c 								:: proc(joystick: ^Joystick) -> ^u8																																					 ---;
	@(link_name="SDL_JoystickNameForIndex") joystick_name_for_index_c 						:: proc(device_index: i32) -> ^u8																																					 ---;
	...
	@(link_name="SDL_LoadFunction") load_function_c 								:: proc(handle: rawptr, name: ^u8) -> rawptr																																		 ---;
	@(link_name="SDL_LoadObject") load_object_c 									:: proc(sofile: ^u8) -> ^u8																																							 ---;
	...
	@(link_name="SDL_Log") log 											:: proc(fmt: ...^u8)																																								 ---;
	@(link_name="SDL_LogCritical") log_critical 									:: proc(category: i32, fmt: ...^u8)																																					 ---;
	@(link_name="SDL_LogDebug") log_debug 										:: proc(category: i32, fmt: ...^u8)																																					 ---;
	@(link_name="SDL_LogError") log_error 										:: proc(category: i32, fmt: ...^u8)																																					 ---;
	...
	@(link_name="SDL_LogInfo") log_info 										:: proc(category: i32, fmt: ...^u8)																																					 ---;
	@(link_name="SDL_LogMessage") log_message 									:: proc(category: i32, priority: Log_Priority, fmt: ...^u8)																															 ---;
	@(link_name="SDL_LogMessageV") log_message_v 									:: proc(category: i32, priority: Log_Priority, fmt: ^u8, va_list: ^u8)																												 ---;
	...
	@(link_name="SDL_LogVerbose") log_verbose 									:: proc(category: i32, fmt: ...^u8)																																					 ---;
	@(link_name="SDL_LogWarn") log_warn 										:: proc(category: i32, fmt: ...^u8)																																					 ---;
	...
	@(link_name="SDL_OpenAudioDevice") open_audio_device_c 							:: proc(device: ^u8, iscapture: i32, desired, obtained: ^Audio_Spec, allowed_changed: i32) -> Audio_Device_Id																			 ---;
	...
	@(link_name="SDL_RegisterApp") register_app_c 									:: proc(name: ^u8, style: u32, h_inst: rawptr) -> i32																																 ---;
	...
	@(link_name="SDL_RWFromFile") rw_from_file_c 									:: proc(file: ^u8, mode: ^u8) -> ^Rw_Ops																																				 ---;
	...
	@(link_name="SDL_SetClipboardText") set_clipboard_text_c 							:: proc(text: ^u8) -> i32																																							 ---;
	...
	@(link_name="SDL_SetError") set_error 										:: proc(fmt: ...^u8) -> i32																																							 ---;
	@(link_name="SDL_SetEventFilter") set_event_filter 								:: proc(filter: Event_Filter, userdata: rawptr)																																		 ---;
	@(link_name="SDL_SetHint") set_hint_c 										:: proc(name, value: ^u8) -> Bool																																					 ---;
	@(link_name="SDL_SetHintWithPriority") set_hint_with_priority_c 						:: proc(name, value: ^u8, priority: Hint_Priority) -> Bool																															 ---;
	...
	@(link_name="SDL_SetWindowData") set_window_data_c 								:: proc(window: ^Window, name: ^u8, userdata: rawptr) -> rawptr																														 ---;
	...
	@(link_name="SDL_SetWindowTitle") set_window_title_c 								:: proc(window: ^Window, title: ^u8)																																				 ---;
	...
	@(link_name="SDL_ShowSimpleMessageBox") show_simple_message_box_c 						:: proc(flags: u32, title, message: ^u8, window: ^Window) -> i32																													 ---;
	...
	@(link_name="SDL_VideoInit") video_init_c 									:: proc(driver_name: ^u8) -> i32																																					 ---;
...
IDirect3D_Device9 :: struct #ordered {};
Rw_Ops :: struct #ordered {};
