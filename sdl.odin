...
foreign lib {
	...
	sdl_create_window 									:: proc() ->																																		#link_name "SDL_CreateWindow" ---;
	sdl_create_window_and_renderer 						:: proc() ->																																		#link_name "SDL_CreateWindowAndRenderer" ---;
	sdl_create_window_from 								:: proc() ->																																		#link_name "SDL_CreateWindowFrom" ---;
	sdl_dxgi_get_output_info 							:: proc() ->																																		#link_name "SDL_DXGIGetOutputInfo" ---;
	sdl_dynapi_entry 									:: proc() ->																																		#link_name "SDL_DYNAPI_entry" ---;
	sdl_del_event_watch 								:: proc() ->																																		#link_name "SDL_DelEventWatch" ---;
	sdl_del_hint_callback 								:: proc() ->																																		#link_name "SDL_DelHintCallback" ---;
	sdl_delay 											:: proc() ->																																		#link_name "SDL_Delay" ---;
	sdl_dequeue_audio 									:: proc() ->																																		#link_name "SDL_DequeueAudio" ---;
	sdl_destroy_cond 									:: proc() ->																																		#link_name "SDL_DestroyCond" ---;
	sdl_destroy_mutex 									:: proc() ->																																		#link_name "SDL_DestroyMutex" ---;
	sdl_destroy_renderer 								:: proc() ->																																		#link_name "SDL_DestroyRenderer" ---;
	sdl_destroy_semaphore 								:: proc() ->																																		#link_name "SDL_DestroySemaphore" ---;
	sdl_destroy_texture 								:: proc() ->																																		#link_name "SDL_DestroyTexture" ---;
	sdl_destroy_window 									:: proc() ->																																		#link_name "SDL_DestroyWindow" ---;
	sdl_detach_thread 									:: proc() ->																																		#link_name "SDL_DetachThread" ---;
	sdl_direct_3d9_get_adapter_index 					:: proc() ->																																		#link_name "SDL_Direct3D9GetAdapterIndex" ---;
	...
	sdl_enclose_points 									:: proc() ->																																		#link_name "SDL_EnclosePoints" ---;
	sdl_error 											:: proc() ->																																		#link_name "SDL_Error" ---;
	sdl_event_state 									:: proc() ->																																		#link_name "SDL_EventState" ---;
	sdl_fill_rect 										:: proc() ->																																		#link_name "SDL_FillRect" ---;
	sdl_fill_rects 										:: proc() ->																																		#link_name "SDL_FillRects" ---;
	sdl_filter_events 									:: proc() ->																																		#link_name "SDL_FilterEvents" ---;
	sdl_flush_event 									:: proc() ->																																		#link_name "SDL_FlushEvent" ---;
	sdl_flush_events 									:: proc() ->																																		#link_name "SDL_FlushEvents" ---;
	sdl_free_cursor 									:: proc() ->																																		#link_name "SDL_FreeCursor" ---;
	sdl_free_format 									:: proc() ->																																		#link_name "SDL_FreeFormat" ---;
	sdl_free_palette 									:: proc() ->																																		#link_name "SDL_FreePalette" ---;
	sdl_free_rw 										:: proc() ->																																		#link_name "SDL_FreeRW" ---;
	sdl_free_surface 									:: proc() ->																																		#link_name "SDL_FreeSurface" ---;
	sdl_free_wav 										:: proc() ->																																		#link_name "SDL_FreeWAV" ---;
