...
foreign lib {
	...
	@(link_name="IMG_LoadTexture") load_texture_c						:: proc(renderer: ^sdl.Renderer, file: ^u8) -> ^sdl.Texture												---;
	@(link_name="IMG_LoadTextureTyped_RW") load_texture_typed_rw_c				:: proc(renderer: ^sdl.Renderer, src: ^sdl.Rw_Ops, freesrc: i32, img_type: ^u8) -> ^sdl.Texture			---;
	@(link_name="IMG_LoadTexture_RW") load_texture_rw						:: proc(renderer: ^sdl.Renderer, src: ^sdl.Rw_Ops, freesrc: i32) -> ^sdl.Texture							---;
	@(link_name="IMG_LoadTyped_RW") load_typed_rw_c						:: proc(src: ^sdl.Rw_Ops, freesrc: i32, img_type: ^u8) -> ^sdl.Surface									---;
	...
	@(link_name="IMG_SavePNG") save_png_c							:: proc(surface: ^sdl.Surface, file: ^u8) -> i32														---;
